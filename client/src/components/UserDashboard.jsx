        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-black">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="/"
                className="flex flex-col items-center text-lg mb-5 font-bold text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0"
              >
                <GiRollingEnergy size={40} color="white" />
                <span className="mx-auto mt-2 text-3xl text-white select-none">
                  Eco
